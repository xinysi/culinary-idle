...
// ── 名称库（每类 30 个，不重复） ──
const FORAGING = ['桃子', '梨', '橙子', '柠檬', '柚子', '樱桃', '蓝莓', '覆盆子', '猕猴桃', '石榴', '红枣', '无花果', '柿子', '荔枝', '龙眼', '枇杷', '山楂', '板栗', '核桃', '杏仁', '花生', '木耳', '银耳', '竹笋', '芦笋', '菠菜', '芹菜', '西兰花', '生菜', '苤蓝']
...
const COOKING = ['东坡肉', '麻婆豆腐', '宫保鸡丁', '糖醋里脊', '回锅肉', '水煮牛肉', '鱼香茄子', '蚂蚁上树', '干煸豆角', '酸菜鱼', '剁椒鱼头', '啤酒鸭', '板栗烧鸡', '香菇滑鸡', '白切鸡', '盐焗鸡', '烧鹅', '蜜汁叉烧', '蜜汁火腿', '红烧狮子头', '腌笃鲜', '蟹粉豆腐', '清炒时蔬', '上汤娃娃菜', '蒜蓉西兰花', '拔丝苹果', '冰糖雪梨', '银耳莲子羹', '杨枝甘露', '八宝饭']
...
const BREWING = ['西瓜汁', '哈密瓜汁', '橙汁', '柠檬汁', '猕猴桃汁', '蓝莓汁', '樱桃汁', '水蜜桃汁', '梨汁', '柚子茶', '柠檬茶', '菊花茶', '玫瑰茶', '薄荷茶', '姜枣茶', '大麦茶', '玄米茶', '抹茶', '奶茶', '冰红茶', '青梅酒', '桂花酒', '樱桃酒', '蓝莓酒', '黄酒', '清酒', '烧酒', '白兰地', '朗姆酒', '果味汽水']
