...
const COOKING = ['香酥鸭', '口水鸡', '夫妻肺片', '毛血旺', '辣子鸡', '干锅花菜', '鱼香肉丝', '京酱肉丝', '木须肉', '锅包肉', '地三鲜', '虎皮青椒', '红烧茄子', '油焖大虾', '白灼虾', '清蒸鲈鱼', '红烧鲫鱼', '糖醋鱼', '烤鱼', '石锅拌饭', '咖喱鸡', '泰式咖喱', '意大利面', '披萨', '汉堡', '三明治', '寿司卷', '天妇罗', '关东煮', '部队锅']
...
const PRESERVING = ['酱油膏', '老抽', '生抽', '梅子酱', '菠萝酱', '草莓酱', '蓝莓酱', '苹果酱', '橙子酱', '桃子酱', '杏子酱', '柚子酱', '樱桃酱', '葡萄酱', '芒果酱', '猕猴桃酱', '山楂酱', '枣泥', '豆沙', '莲蓉', '椰蓉', '芝麻馅', '五仁馅', '腊肠', '腊肉', '酱鸭', '酱肘子', '酱牛肉', '咸鸭蛋', '皮蛋']
const BREWING = ['酸梅汤', '冬瓜茶', '洛神花茶', '桂圆红枣茶', '枸杞茶', '茉莉花茶', '乌龙茶', '铁观音', '普洱茶', '龙井', '碧螺春', '白桃汽水', '姜汁汽水', '苏打水', '苹果汽水', '葡萄汽水', '杨梅酒', '荔枝酒', '龙眼酒', '桃酒', '苹果酒', '梨酒', '西瓜酒', '香蕉酒', '芒果酒', '菠萝酒', '椰子酒', '青柠汁', '百香果汁', '山竹汁']
const SPICE = ['麻辣粉', '香辣粉', '椒麻粉', '照烧汁', '甜辣酱', '蒜蓉酱', '香草酱', '薄荷酱', '柠檬胡椒盐', '黑松露盐', '海盐', '玫瑰盐', '竹盐', '低钠盐', '烤肉酱', '蜜汁酱', '咖喱膏', '沙姜粉', '五香粉', '桂皮粉', '花椒粉', '青花椒粉', '黑胡椒粉', '迷迭香盐', '百里香粉', '牛至粉', '罗勒粉', '鼠尾草粉', '欧芹碎', '莳萝粉']
