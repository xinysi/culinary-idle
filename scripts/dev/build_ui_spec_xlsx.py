...
ART = [
    ...
    ["SEAL_CHOP", "食印 · 筷（长印）", "菜单签页签选中", "固定", "1 张", "16×20 长印", "与方形印区分「页签」与「按钮」"],
    ...
    ["LOCK_LINEWORK", "线稿铜锁", "锁定态", "固定", "1 张", "13px；方形锁体 + 半圆锁梁 + 匙孔", "替换 🔒 emoji"],
    ...
    ["WM_CHOPREST", "水印 · 筷架", "物品图底座", "固定", "1 张", "48×48", "只在物品图小方框里用"],
]
