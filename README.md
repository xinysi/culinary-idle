...
| 小游戏 | 2026-09 | 🎮 小游戏大厅（顶部导航第三页单入口）：**🛒 游戏商店 + 七款游戏**统一「多模式分类 + 📖模式说明弹窗」；**2026-09-07 货币改革**：七款小游戏奖励全部改为**游戏币**（`player.gameCoins`，像素金币图标 `images/icon-coin.png`，与主金币分离），**游戏商店**（`GameShopView`，大厅第一入口）19 件商品全部真实生效（背包满自动直发仓库）：金币兑换包 100/900/9000 币（+1000/+10000/+100000 金）、稀有食材盲盒 120/1000/10000 币（1~3/10~30/100~300 份）、鲜味食材礼包 500（30~80 份）/珍馐料理礼包 1500（10~20 份）/精酿调料礼包 400（20~50 份）/锻造矿材礼包 800（20~50 份）、双倍挂机药剂(30min)、神秘种子袋 60/500/5000 币（3/30/300 颗）、觅珍抽卡券 200/1800/18000 币（×1/×10/×100，抽卡优先抵扣）、制作加速器(队列快进10分钟)、「大胃王」称号、「神厨」头像框(金色描边)、限定头像·食神盛宴（后三者一次性、购后锁定）· 按钮置底全宽；火候炉（**十模式**：新手宽区/慢火/经典/疾速/快燃/极限单轨 + 双锅同调/疾速/极限 + 精准单轨，速度·双轨·完美区宽参数化）、美食讲堂（**十模式**：知识入门/标准/大师、对比试炼/挑战、连线试炼/挑战、综合标准12题≥10/进阶15题≥13/大师18题≥16，达标得徽章+游戏币）、厨心 2048（**十模式**：3×3/4×4/5×5/6×6 × 出4率 5%/10%/30%/55%，标准合并/每步1新块/单次合并不级联，动画、图片制档位（8192+至高 262144 佛跳墙）、奖励×模式倍率、最佳分按模式独立）、大胃王（**十模式**：15s→300s 时长梯度，暴食×2、提前结算、累计游戏币无上限）、每日美食拼图（**十模式**：2×2~8×8 + 3/4/5×5 限步，图片与乱序每次随机、限步超步失败）、食材连连看（**十模式**：偶数棋盘 2×2/4×4/6×6/8×8/10×10 恰好填满无缺格 + 限时 60/90/120s、限步 16/30 步玩法变体，全清得游戏币）、**食材翻牌**（🧠 独立第七款：牌面 ❓ 记忆配对、3D 翻转/翻错抖动/消除缩放动画、翻错盖回，**十模式**：2×2/4×4/6×6/8×8/10×10 偶数棋盘 × 普通/限时/限翻，最佳=最少翻牌次数）；**2026-09-07 统一**：奖励全部游戏币（无 buff/饼干）、取消每日限制、按钮/文字/状态胶囊统一规范、图鉴物品图片固定尺寸（object-fit contain）；**2026-09-08 深色适配**：八款小游戏界面全面适配深色模式（html[data-theme="dark"] 覆盖层 100+ 规则），入口改短名（🛒商店/📚讲堂/🧩2048/🧩拼图/🀄连连看/🧠翻牌），奖励与商店定价平衡（大胃王碗×0.33 权重、2048 档位提档、讲堂徽章兑换 200/450/800、连连看下调、商店批量折扣 9000/4500/880/8500/17000、购买按钮橙色、进度条轨道橙金、2048 方向键深色适配） |
