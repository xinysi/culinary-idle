...
| 图鉴卡牌化 | §13 | 收集品卡牌化展示（稀有度配色）+ 3v3 卡牌对战小游戏（胜 +50 金币） |
...
- 其他修复：99 级经验钳制、图鉴完成度一位小数、公会任务按本地日期重置、负数金币/物品防护、探索离线金币入账；觅珍页暗色模式 21 条规则修复（组件内 `:global` 写法从未编译生效，迁移至 main.css `html[data-theme='dark']` 全局块）
