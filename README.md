...
| 小游戏 | 2026-09 | 🎮 小游戏大厅（顶部导航第三页单入口）：**🛒 游戏商店 + 七款游戏**统一「多模式分类 + 📖模式说明弹窗」；**2026-09-07 货币改革**：七款小游戏奖励全部改为**游戏币**（`player.gameCoins`，像素金币图标 `images/icon-coin.png`，与主金币分离），**游戏商店**（`GameShopView`，大厅第一入口）48 件商品全部真实生效（背包满自动直发仓库）：金币兑换包 100/900/9000 币（+1000/+10000/+100000 金）、稀有食材盲盒 120/1000/10000 币（1~3/10~30/100~300 份）、鲜味食材礼包 500（30~80 份）/珍馐料理礼包 1500（10~20 份）/精酿调料礼包 400（20~50 份）/锻造矿材礼包 800（20~50 份）、双倍挂机药剂(30min)、神秘种子袋 60/500/5000 币（3/30/300 颗）、觅珍抽卡券 200/1800/18000 币（×1/×10/×100，抽卡优先抵扣）、制作加速器(队列快进10分钟)、外观纪念 30 件（购后可在已拥有间免费佩戴切换）：称号 ×7（大胃王/食神/千杯不醉/火候大师/刀工宗师/食灵之主/满汉全席）、头像框 ×10（神厨·金/翡翠/皇紫/赤铜/白银/熔岩/霜蓝/彩虹/星辉/龙鳞）、头像 ×4、名字特效 ×9（鎏金/银辉/青竹/桃夭/赤焰/碧波/紫电/薄荷/琥珀）（6000~26000 币）· 按钮置底全宽；火候炉（**十模式**：新手宽区/慢火/经典/疾速/快燃/极限单轨 + 双锅同调/疾速/极限 + 精准单轨，速度·双轨·完美区宽参数化）、美食讲堂（**十模式**：知识入门/标准/大师、对比试炼/挑战、连线试炼/挑战、综合标准12题≥10/进阶15题≥13/大师18题≥16，达标得徽章+游戏币）、厨心 2048（**十模式**：3×3/4×4/5×5/6×6 × 出4率 5%/10%/30%/55%，标准合并/每步1新块/单次合并不级联，动画、图片制档位（8192+至高 262144 佛跳墙）、奖励×模式倍率、最佳分按模式独立）、大胃王（**十模式**：15s→300s 时长梯度，暴食×2、提前结算、累计游戏币无上限）、每日美食拼图（**十模式**：2×2~8×8 + 3/4/5×5 限步，图片与乱序每次随机、限步超步失败）、食材连连看（**十模式**：偶数棋盘 2×2/4×4/6×6/8×8/10×10 恰好填满无缺格 + 限时 60/90/120s、限步 16/30 步玩法变体，全清得游戏币）、**食材翻牌**（🧠 独立第七款：牌面 ❓ 记忆配对、3D 翻转/翻错抖动/消除缩放动画、翻错盖回，**十模式**：2×2/4×4/6×6/8×8/10×10 偶数棋盘 × 普通/限时/限翻，最佳=最少翻牌次数）；**2026-09-07 统一**：奖励全部游戏币（无 buff/饼干）、取消每日限制、按钮/文字/状态胶囊统一规范、图鉴物品图片固定尺寸（object-fit contain）；**2026-09-09 果了个果**（🍇 第 15 款，羊了个羊式）：多层堆叠卡牌（半格错位），**被压住的卡灰显且点击无效** · 点击未被压住的卡入底部 7 格卡槽 · 凑 3 张同款立即消除（同款相邻排列）+ 上层消除后下层解锁高亮 · **卡槽填满 7 格即判负** · 清空全部卡牌通关得游戏币 · **十关模式**（1~7 层、9~135 张、3~12 种水果，60~380 币）· 可解性保证：发牌按「层序三元组」分配，玩家按同序取牌必可全清 · 道具提示×2/洗牌×1/撤回×1 · 点击浮入/三消爆炸/解锁淡入/通关礼花 + Web Audio 音效；**2026-09-09 水果合成修复**：暴击特效由黄色全屏闪光改为**烟花粒子**（18 颗彩色粒子四散+重力+淡出）· 落果加 ±3.5px 随机抖动 + 撞击瞬间横向扰动（消除"完美叠柱"）· 碰撞解算改 **3 次迭代**（消除互相穿透）· 新增**睡眠机制 + 接触阻尼**（贴地/互靠的果实速度自转衰减至静止，不再无休止滚动；修复 touched TDZ 报错）；离线确定性仿真验证：全静止（速度/自转=0、全部睡眠）、零穿透、无叠柱、越线判负、烟花粒子正常生成；
