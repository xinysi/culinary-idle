...
export const ACHIEVEMENTS = [
  ...
  { id: 'expeditionTier5', name: '六路总管', category: '特殊', desc: `${EXPEDITIONS.length} 条采集队线路各达最高熟练度档`, title: '六路总管', reward: { gold: 18000, items: { mysterySpice: 2 } }, check: (p) => EXPEDITIONS.every((e) => expeditionTier(p.expeditions?.[e.id]?.completions ?? 0) >= EXPEDITION_TIER_STEPS.length) },
