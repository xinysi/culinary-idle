...
const TASKS = {
  ...
  craft: (id) => mkTasks(id, [
    ...
    // v2.10.0：副业四支
    ['陶艺 ×10', 'skill', 'pottery', 10, 20],
    ['编织 ×10', 'skill', 'weaving', 10, 20],
    ['刺绣 ×10', 'skill', 'embroidery', 10, 20],
    ['制烛 ×10', 'skill', 'candles', 10, 20],
    // v2.12.0 第一批
    ['制箭 ×10', 'skill', 'fletching', 10, 20],
    ['制网 ×10', 'skill', 'netmaking', 10, 20],
