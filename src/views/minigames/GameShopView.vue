...
const PRODUCTS = {
  gold: {
    cat: '💰 经济互通',
    icon: '💰', name: '金币兑换包', price: 350, repeat: true,
    desc: '100 游戏币 → 金币 ×1000（主货币互通）',
    apply() { player.gainGold(1000); return '金币 +1000' },
  },
  goldDeluxe: {
    cat: '💰 经济互通',
    icon: '💰', name: '豪华金币兑换包', price: 2800, repeat: true,
    desc: '900 游戏币 → 金币 ×10000',
    apply() { player.gainGold(10000); return '金币 +10000' },
  },
  goldPremium: {
    cat: '💰 经济互通',
    icon: '💰', name: '至臻金币兑换包', price: 22000, repeat: true,
    desc: '9000 游戏币 → 金币 ×100000',
    apply() { player.gainGold(100000); return '金币 +100000' },
  },
  rareBox: {
    cat: '💰 经济互通',
    icon: '🎁', name: '稀有食材盲盒', price: 450, repeat: true,
    desc: '随机稀有食材 1~3 份（灵果/龙根/松露/灵芝池）',
    apply() { return rareBoxApply(1, 3) },
  },
  rareBoxDeluxe: {
    cat: '💰 经济互通',
    icon: '🎁', name: '豪华稀有食材盲盒', price: 3200, repeat: true,
    desc: '随机稀有食材 10~30 份（灵果/龙根/松露/灵芝池）',
    apply() { return rareBoxApply(10, 30) },
  },
  rareBoxPremium: {
    cat: '💰 经济互通',
    icon: '🎁', name: '至臻稀有食材盲盒', price: 21000, repeat: true,
    desc: '随机稀有食材 100~300 份（灵果/龙根/松露/灵芝池）',
    apply() { return rareBoxApply(100, 300) },
  },
  ingredientBag: {
    cat: '💰 经济互通',
    icon: '🐟', name: '鲜味食材礼包', price: 1300, repeat: true,
    desc: '随机普通食材 30~80 份（蔬菜/鲜肉/水产等，不含稀有）',
    apply() { return poolBagApply(INGREDIENT_POOL, 30 + Math.floor(Math.random() * 51)) },
  },
  foodBag: {
    cat: '💰 经济互通',
    icon: '🥩', name: '珍馐料理礼包', price: 3800, repeat: true,
    desc: '随机成品料理 10~20 份（备菜快进，可回血/对决用）',
    apply() { return poolBagApply(FOOD_POOL, 10 + Math.floor(Math.random() * 11)) },
  },
  spiceBag: {
    cat: '💰 经济互通',
    icon: '🌶️', name: '精酿调料礼包', price: 1000, repeat: true,
    desc: '随机调料 20~50 份（香料/酱料池）',
    apply() { return poolBagApply(SPICE_POOL, 20 + Math.floor(Math.random() * 31)) },
  },
  mineralBag: {
    cat: '💰 经济互通',
    icon: '⛏️', name: '锻造矿材礼包', price: 2000, repeat: true,
    desc: '随机矿石/宝石 20~50 份（锻造原料池）',
    apply() { return poolBagApply(MINERAL_POOL, 20 + Math.floor(Math.random() * 31)) },
  },
  xpPotion: {
    cat: '⚡ 增益加速',
    icon: '🔥', name: '双倍挂机药剂', price: 320, repeat: true,
    desc: '采集/制作经验 ×2 · 持续 30 分钟（覆盖式刷新）',
    apply() { player.buffs.xpMult = { mult: 2, expiresAt: Date.now() + 30 * 60_000 }; return '经验 ×2（30 分钟）' },
  },
  seedBag: {
    cat: '⚡ 增益加速',
    icon: '🌱', name: '神秘种子袋', price: 300, repeat: true,
    desc: '随机 3 颗可种作物种子（含稀有，开出即赚）',
    apply() { return seedBagApply(3) },
  },
  seedBagDeluxe: {
    cat: '⚡ 增益加速',
    icon: '🌱', name: '豪华神秘种子袋', price: 1600, repeat: true,
    desc: '随机 30 颗可种作物种子（含稀有，开出即赚）',
    apply() { return seedBagApply(30) },
  },
  seedBagPremium: {
    cat: '⚡ 增益加速',
    icon: '🌱', name: '至臻神秘种子袋', price: 13000, repeat: true,
    desc: '随机 300 颗可种作物种子（含稀有，开出即赚）',
    apply() { return seedBagApply(300) },
  },
  gachaTicket: {
    cat: '🧰 便捷用品',
    icon: '🎴', name: '觅珍抽卡券', price: 520, repeat: true,
    desc: '觅珍抽卡券 ×1（抽卡时优先抵扣，剩余金币补齐）',
    apply() { return ticketApply(1) },
  },
  gachaTicket10: {
    cat: '🧰 便捷用品',
    icon: '🎴', name: '觅珍抽卡券·十连', price: 4700, repeat: true,
    desc: '觅珍抽卡券 ×10（九折，抽卡优先抵扣）',
    apply() { return ticketApply(10) },
  },
  gachaTicket100: {
    cat: '🧰 便捷用品',
    icon: '🎴', name: '觅珍抽卡券·百连', price: 39000, repeat: true,
    desc: '觅珍抽卡券 ×100（九折，抽卡优先抵扣）',
    apply() { return ticketApply(100) },
  },
  craftBoost: {
    cat: '🧰 便捷用品',
    icon: '⏩', name: '制作加速器', price: 300, repeat: true,
    desc: '全部制作队列立即快进 10 分钟产量（材料不足自动暂停不浪费）',
    apply() { const n = player.boostCraftQueues(10); return `队列快进 10 分钟（完成 ${n} 份产物）` },
  },
  title: {
    cat: '👑 外观纪念',
    icon: '👑', name: '「大胃王」称号', price: 14000, repeat: false, slot: 'title', value: '大胃王',
    desc: '永久称号 · 购后可在已拥有外观间免费切换',
  },
  title2: {
    cat: '👑 外观纪念',
    icon: '👑', name: '「御膳食神」称号', price: 16800, repeat: false, slot: 'title', value: '御膳食神',
    desc: '永久称号 · 厨艺巅峰',
  },
  title3: {
    cat: '👑 外观纪念',
    icon: '🏅', name: '「千杯不醉」称号', price: 21000, repeat: false, slot: 'title', value: '千杯不醉',
    desc: '永久称号 · 酒仙风范',
  },
  title4: {
    cat: '👑 外观纪念',
    icon: '🔥', name: '「火候大师」称号', price: 15400, repeat: false, slot: 'title', value: '火候大师',
    desc: '永久称号 · 掌火如神',
  },
  title5: {
    cat: '👑 外观纪念',
    icon: '🔪', name: '「刀工宗师」称号', price: 18200, repeat: false, slot: 'title', value: '刀工宗师',
    desc: '永久称号 · 刀走龙蛇',
  },
  title6: {
    cat: '👑 外观纪念',
    icon: '👻', name: '「食灵之主」称号', price: 22400, repeat: false, slot: 'title', value: '食灵之主',
    desc: '永久称号 · 万灵归心',
  },
  title7: {
    cat: '👑 外观纪念',
    icon: '🍲', name: '「满汉全席」称号', price: 25200, repeat: false, slot: 'title', value: '满汉全席',
    desc: '永久称号 · 宴压天下',
  },
  frame: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「神厨」金框', price: 16800, repeat: false, slot: 'avatarFrame', value: 'gold',
    desc: '永久金色头像框，头像描边发光',
  },
  frameJade: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「翡翠」头像框', price: 14000, repeat: false, slot: 'avatarFrame', value: 'jade',
    desc: '永久翡翠绿头像框 · 翠玉质感光晕',
  },
  frameRoyal: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「皇紫」头像框', price: 25200, repeat: false, slot: 'avatarFrame', value: 'royal',
    desc: '永久皇家紫头像框 · 尊贵光晕',
  },
  frameCopper: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「赤铜」头像框', price: 11200, repeat: false, slot: 'avatarFrame', value: 'copper',
    desc: '永久赤铜头像框 · 暖铜光晕',
  },
  frameSilver: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「白银」头像框', price: 14000, repeat: false, slot: 'avatarFrame', value: 'silver',
    desc: '永久白银头像框 · 冷银光晕',
  },
  frameLava: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「熔岩」头像框', price: 19600, repeat: false, slot: 'avatarFrame', value: 'lava',
    desc: '永久熔岩头像框 · 炽热红光',
  },
  frameFrost: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「霜蓝」头像框', price: 19600, repeat: false, slot: 'avatarFrame', value: 'frost',
    desc: '永久霜蓝头像框 · 冰晶蓝光',
  },
  frameRainbow: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「彩虹」头像框', price: 28000, repeat: false, slot: 'avatarFrame', value: 'rainbow',
    desc: '永久彩虹头像框 · 三色光环',
  },
  frameStar: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「星辉」头像框', price: 30800, repeat: false, slot: 'avatarFrame', value: 'star',
    desc: '永久星辉头像框 · 双层金色光晕',
  },
  frameDragon: {
    cat: '👑 外观纪念',
    icon: '🖼️', name: '「龙鳞」头像框', price: 36400, repeat: false, slot: 'avatarFrame', value: 'dragon',
    desc: '永久龙鳞头像框 · 金绿龙气',
  },
  avatar: {
    cat: '👑 外观纪念',
    icon: '🧸', name: '头像·食神盛宴', price: 8400, repeat: false, slot: 'avatar', value: 'images/items/food/食神盛宴.png',
    desc: '商店专属头像（食神盛宴图，购后免费切换）',
  },
  avatar2: {
    cat: '👑 外观纪念',
    icon: '🧸', name: '头像·满汉全席', price: 11200, repeat: false, slot: 'avatar', value: 'images/items/food/传说满汉全席.png',
    desc: '商店专属头像（传说满汉全席图）',
  },
  avatar3: {
    cat: '👑 外观纪念',
    icon: '🧸', name: '头像·龙息烤全龙', price: 12600, repeat: false, slot: 'avatar', value: 'images/items/food/龙息烤全龙.png',
    desc: '商店专属头像（龙息烤全龙图）',
  },
  avatar4: {
    cat: '👑 外观纪念',
    icon: '🧸', name: '头像·金龙鱼全宴', price: 9800, repeat: false, slot: 'avatar', value: 'images/items/food/金龙鱼全宴.png',
    desc: '商店专属头像（金龙鱼全宴图）',
  },
  nameGold: {
    cat: '👑 外观纪念',
    icon: '🥇', name: '名字·鎏金', price: 28000, repeat: false, slot: 'nameColor', value: 'gold',
    desc: '永久名字特效 · 鎏金',
  },
  nameSilver: {
    cat: '👑 外观纪念',
    icon: '🥈', name: '名字·银辉', price: 19600, repeat: false, slot: 'nameColor', value: 'silver',
    desc: '永久名字特效 · 银辉',
  },
  nameBamboo: {
    cat: '👑 外观纪念',
    icon: '🎋', name: '名字·青竹', price: 16800, repeat: false, slot: 'nameColor', value: 'bamboo',
    desc: '永久名字特效 · 青竹',
  },
  namePeach: {
    cat: '👑 外观纪念',
    icon: '🌸', name: '名字·桃夭', price: 16800, repeat: false, slot: 'nameColor', value: 'peach',
    desc: '永久名字特效 · 桃夭',
  },
  nameFlame: {
    cat: '👑 外观纪念',
    icon: '🔥', name: '名字·赤焰', price: 22400, repeat: false, slot: 'nameColor', value: 'flame',
    desc: '永久名字特效 · 赤焰',
  },
  nameWave: {
    cat: '👑 外观纪念',
    icon: '🌊', name: '名字·碧波', price: 22400, repeat: false, slot: 'nameColor', value: 'wave',
    desc: '永久名字特效 · 碧波',
  },
  nameThunder: {
    cat: '👑 外观纪念',
    icon: '⚡', name: '名字·紫电', price: 25200, repeat: false, slot: 'nameColor', value: 'thunder',
    desc: '永久名字特效 · 紫电',
  },
  nameMint: {
    cat: '👑 外观纪念',
    icon: '🍃', name: '名字·薄荷', price: 18200, repeat: false, slot: 'nameColor', value: 'mint',
    desc: '永久名字特效 · 薄荷',
  },
  nameEmber: {
    cat: '👑 外观纪念',
    icon: '🟠', name: '名字·琥珀', price: 21000, repeat: false, slot: 'nameColor', value: 'ember',
    desc: '永久名字特效 · 琥珀',
  },
}
