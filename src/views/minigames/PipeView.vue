...
const MODES = {
  ...
  m3: { label: '模式3', n: 4, moves: 22, valves: 1, dual: false, gold: 40, desc: '4×4 · <b>单向阀</b>（汤汁只能顺着箭头流）· 22 步 · +40 币' },
  ...
  m6: { label: '模式6', n: 5, moves: 44, valves: 0, dual: true, gold: 80, desc: '5×5 · <b>双锅双碗</b>（🍲🍚 橙对 + 🥘🥣 绿对，同对同色）· 44 步 · +80 币' },
      ...
      <div class="pp-info-box">
        ...
        <div class="pp-info-list">
          ...
          <div v-for="(m, key) in MODES" :key="key" class="pp-info-row">
            ...
            <span class="pp-info-desc" v-html="m.desc"></span>
          </div>
        </div>
      </div>
    </div>
