...
.sl-stage { position: relative; border-radius: 16px; background: rgba(120, 84, 50, 0.22); border: 1px solid rgba(var(--tint-rgb), 0.35); box-shadow: 0 10px 28px rgba(var(--tint-deep-rgb), 0.18); overflow: hidden; }
...
.sl-tile { position: absolute; display: flex; align-items: center; justify-content: center; border-radius: 12px; background: rgba(var(--panel-rgb), 0.92); border: 1px solid rgba(var(--tint-rgb), 0.35); box-shadow: 0 2px 6px rgba(var(--tint-deep-rgb), 0.18); cursor: pointer; transition: left 0.14s ease, top 0.14s ease, box-shadow 0.14s; overflow: hidden; }
.sl-tile:hover { box-shadow: 0 4px 12px rgba(var(--primary-strong-rgb), 0.3); }
.sl-tile.star { border-color: var(--gold); box-shadow: 0 0 0 2px rgba(224, 161, 58, 0.35), 0 2px 6px rgba(var(--tint-deep-rgb), 0.18); }
...
.sl-preview-cell { position: relative; aspect-ratio: 1; border-radius: 4px; background: rgba(var(--panel-rgb), 0.88); display: flex; align-items: center; justify-content: center; overflow: hidden; }
...
.sl-reset { padding: 10px 24px; border-radius: 12px; font-weight: 700; cursor: pointer; color: #fff; background: linear-gradient(135deg, var(--accent), var(--accent-strong)); border: none; }

.sl-mask { position: fixed; inset: 0; z-index: 320; background: rgba(var(--scrim-cool-rgb), 0.5); display: flex; align-items: center; justify-content: center; backdrop-filter: blur(4px); }
.sl-result { width: min(460px, 92vw); max-height: 80vh; overflow: auto; background: rgba(var(--panel-rgb), 0.96); border: 1px solid rgba(var(--tint-rgb), 0.35); border-radius: 18px; padding: 18px 20px; box-shadow: 0 16px 44px rgba(var(--scrim-rgb), 0.4); display: flex; flex-direction: column; gap: 10px; }
...
.sl-again { align-self: center; margin-top: 4px; padding: 10px 28px; border-radius: 999px; font-weight: 800; cursor: pointer; color: #fff; background: linear-gradient(135deg, var(--accent), var(--accent-strong)); border: none; }
...
.sl-info-mask { position: fixed; inset: 0; z-index: 300; background: rgba(var(--scrim-rgb), 0.45); display: flex; align-items: center; justify-content: center; backdrop-filter: blur(3px); }
.sl-info-box {
